...
import { performLogout } from './logout'; // Import the logout function here
    ...
    return (
        <div style={{ border: "2px", borderColor: "black" }} >
            <List>
                ...
                <ListItem>
                    <img src={add} title="Post tweet" alt="Post tweet" onClick={handleOpenDialog} style={{ cursor: "pointer", width: "5vh", height: "5vh" }} />
                </ListItem>
                {isAuth ? 
                <ListItem>
